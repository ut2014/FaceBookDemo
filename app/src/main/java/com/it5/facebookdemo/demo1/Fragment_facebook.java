...
public class Fragment_facebook extends Fragment{
    ...
    private final String PENDING_ACTION_BUNDLE_KEY =
            "com.it5.facebookdemo:PendingAction";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        login(savedInstanceState,v);
        v.findViewById(R.id.sharing).setOnClickListener(new View.OnClickListener() {
            @Override
...
//        });
    ...
    private void sharing() {
        ...
        shareLinkContentBuilder.setContentDescription("mes")
                .setContentTitle("sss")
                .setContentUrl(Uri.parse("http://wwww.soso.com"));
    ...
    private void login(Bundle savedInstanceState,View v){
...
//                request.executeAsync();
    ...
    private void postPhoto() {
        Bitmap image = BitmapFactory.decodeResource(this.getResources(), R.drawable.com_facebook_favicon_blue);
