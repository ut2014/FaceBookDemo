...
package com.it5.facebookdemo.demo3.platform;
...
public class ContactOperations {
     ...
     * @param lastName type of name: family name, given name, etc.
     * @return instance of ContactOperations
     */
     ...
     * @ existingName Name of contact stored in provider
     * @ nameType type of name: family name, given name, etc.
     * @param uri Uri for the existing raw contact to be updated
     * @return instance of ContactOperations
     */
